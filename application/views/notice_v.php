		...
		<div class="row def-width-1200 bwhite" id="contents-1" style="display: none;">
			<div class="col-md-6 pdg30">
				...
				<p class="cp1 we200 ln18 tale">
					...
					현장 테라피와 동일한 내용, 시스템으로 진행되며 동일하게 테라피스트의 케어를 받으실 수 있습니다. 또한, 심화테라피, 환불보증제도까지도 동일하게 진행됩니다.<br><br>
				</p>				
				<img src="/images/meet_sample.jpg" width="100%">
				<div class="h015"></div>
			...
			<div class="col-md-6 pdg30">
				...
				<p class="cp1 we200 ln18 tale">
					<b>알렌카는 1회에 한하여 무료로 테스트 테라피를 진행할 예정</b>입니다. 1차 테라피에 한하며 추첨을 통하여 인원을 선별할 예정입니다. <br><br>
					E-Mail 주소를 남겨주시면 추첨 당일 안내 메일을 발송해드립니다. <b>24시간 이내에 회신이 없을 경우 대기자에게 기회가 넘어감</b>을 유의하시기 바랍니다.
				</p>				
				<div class="h020"></div>
				<table width="100%"">
					<tr>
				...
				<p class="cp2 we200 tgray ln18 tale">
					* 추첨은 <b>2018년 9월 30일 일요일</b>에 일괄적으로 진행하여 메일로 안내됩니다.<br>
